        ...
        $this->tag(
            ...
            $this->tag(
                ...
                $this->tag(
                    ...
                    . $this->tag('th', array('colspan'=>2, 'data-keyfarming'), 'Keys to farm')
                    . $this->tag('th', array('rowspan'=>2), 'To')
                    . $this->tag('th', array('rowspan'=>2, 'data-keyfarming'), 'Keys After')
                    . $this->tag('th', array('rowspan'=>2), 'AP')
                )
                . $this->tag(
                    'tr',
                    $this->tag('th', array('data-keyfarming'=>true, ), 'by now')
                    . $this->tag('th', array('data-keyfarming'=>true, ), 'Total')
                )
            )
            . $this->tag('tbody')
        )
